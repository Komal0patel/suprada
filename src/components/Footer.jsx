      ...
      <div className="footer-normal-container">
        ...
        <div className="footer-normal-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', cursor: 'pointer' }} onClick={() => onNavigate('home')}>
              ...
              <div>
                ...
                <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.74rem', letterSpacing: '0.22em', textTransform: 'uppercase', color: 'var(--redwood)', opacity: 0.9, fontWeight: 700 }}>
                  WELLNESS
                </span>
              </div>
            </div>

            <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--fs-body)', color: 'rgba(94, 39, 53, 0.88)', lineHeight: 1.65, margin: 0, fontWeight: 400 }}>
            ...
            <div style={{ display: 'flex', gap: '0.6rem', marginTop: '0.4rem' }}>
              ...
              <a href="https://wa.me/917892596969" target="_blank" rel="noreferrer" className="footer-normal-social" aria-label="WhatsApp">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.9rem', fontSize: 'var(--fs-body)', color: 'rgba(94, 39, 53, 0.88)', lineHeight: 1.6, fontFamily: 'var(--font-body)' }}>
