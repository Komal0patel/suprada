...
export default function Spaces({ onNavigate }) {
  ...
  const accommodationBlocks = [
    ...
    { 
      ...
      desc: 'Captures morning sunlight & river breeze.', 
      config: 'Deluxe & Super Deluxe',
    ...
    { 
      ...
      desc: 'Quiet zones designed for deep sleep recovery.', 
      config: 'Deluxe & Super Deluxe',
      bg: 'var(--tea-green)',
      borderColor: 'var(--sage)',
    ...
    { 
      ...
      desc: 'Opens onto a shared courtyard & water feature.', 
      config: 'Courtyard Units (1-4)',
      bg: 'rgba(220, 160, 50, 0.14)',
      borderColor: 'var(--harvest-gold)',
      tag: '✦ COURTYARD OASIS',
    ...
    { 
      ...
      desc: 'Ground floor cottages with direct garden access.', 
      config: 'Super Deluxe (3 Units)',
      bg: 'var(--tea-green)',
      borderColor: 'var(--sage)',
      tag: '✦ GROUNDED EARTH',
    ...
    { 
      ...
      desc: 'Ultra-private cottage with in-house therapy suite.', 
      config: 'Premium Private Cottage',
      bg: 'rgba(184, 94, 76, 0.1)',
      borderColor: 'var(--redwood)',
    ...
    <div ref={scrollRef} style={{ backgroundColor: 'var(--antique-white)', minHeight: '100vh', position: 'relative', overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        >
          ...
          <AnimatedParagraph
            text="Crafted with sacred Indian spatial proportions, mud-plastered walls, and riverfront solitude — every corner of our riverfront retreat is designed to restore your nervous system to its natural rhythm."
            style={{
