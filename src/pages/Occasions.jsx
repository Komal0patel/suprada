...
export default function Occasions({ onNavigate }) {
  ...
  return (
    <div style={{ backgroundColor: 'var(--isabelline)', minHeight: '100vh', overflowX: 'hidden', position: 'relative' }}>
      ...
      {/* Our Spaces CTA Section */}
      <section style={{ padding: '4.5rem 8%', backgroundColor: 'var(--isabelline)', textAlign: 'center', borderTop: '1px solid rgba(94, 39, 53, 0.08)', position: 'relative', overflow: 'hidden' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <h2 style={{ color: 'var(--wine)', margin: '0 0 1rem 0', fontFamily: 'var(--font-heading)', fontSize: 'clamp(2rem, 3.5vw, 2.8rem)', fontWeight: 700 }}>
            Discover Our Spaces
          </h2>
          ...
          <button
            ...
            className="btn-luxury"
            style={{ padding: '0.9rem 2.6rem', fontSize: '0.85rem' }}
          >
            Explore Our Spaces &rarr;
          </button>
        </div>
      </section>
