      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
          <span style={{ 
            ...
            <Star size={12} style={{ color: 'var(--redwood)' }} /> PRAKṚTIREVA BHEṢAJAM • NATURE IS THE MEDICINE
          </span>
          ...
          <h1 style={{ 
            ...
            Naturopathy <em style={{ fontStyle: 'italic', color: 'var(--redwood)' }}>&amp; Holistic Wellness</em>
          </h1>
