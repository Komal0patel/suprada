...
export default function Stay({ onNavigate }) {
  ...
  const cottageList = [
    ...
    },
    {
      ...
      desc: "Samruddhi offers Executive Cottages on the upper floors. These elevated rooms provide sweeping views of the tree canopy and the distant river, elevating your perspective.",
