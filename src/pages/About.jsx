...
export default function About({ onNavigate }) {
  ...
  const teamMembers = [
    { name: 'Late Renuka Nagaraju', role: 'Founder Inspiration', company: 'Suprada Wellness', category: 'leadership', quote: 'Inspiring Suprada’s core vision of compassionate holistic living and sacred healing.', color: 'var(--wine)', initials: 'RN' },
