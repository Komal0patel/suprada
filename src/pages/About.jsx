  ...
  return (
    <div ref={scrollRef} style={{ backgroundColor: 'var(--antique-white)', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        <Pattern24 style={{ position: 'absolute', top: '-20px', left: '-20px', width: 'clamp(120px, 18vw, 200px)', opacity: 0.1, color: 'var(--wine)', pointerEvents: 'none' }} />
        <Pattern25 style={{ position: 'absolute', bottom: '-20px', right: '-20px', width: 'clamp(120px, 18vw, 200px)', opacity: 0.1, color: 'var(--wine)', pointerEvents: 'none' }} />
