...
export default function About({ onNavigate }) {
  ...
  const teamMembers = [
    ...
    { name: 'Acharya Dr. M. Nagaraju', role: 'Co-Chairman', company: 'Suprada Wellness', category: 'leadership', quote: 'Pioneering traditional Vedic wisdom and holistic health systems.', color: 'var(--wine)', initials: 'AN' },
