...
export default function Occasions({ onNavigate }) {
  ...
  return (
    <div style={{ backgroundColor: 'var(--isabelline)', minHeight: '100vh', overflowX: 'hidden', position: 'relative' }}>
      ...
      <Pattern24 style={{ position: 'absolute', top: '20%', left: '-30px', maxWidth: 'clamp(140px, 20vw, 220px)', width: '100%', height: 'auto', opacity: 0.08, color: 'var(--wine)', pointerEvents: 'none', zIndex: 0 }} />
      <Pattern25 style={{ position: 'absolute', top: '55%', right: '-30px', maxWidth: 'clamp(140px, 20vw, 220px)', width: '100%', height: 'auto', opacity: 0.08, color: 'var(--wine)', pointerEvents: 'none', zIndex: 0 }} />
      ...
      <section className="mobile-hero-compact" style={{
        ...
        <Pattern24 style={{ position: 'absolute', top: '-15px', left: '-20px', width: 'clamp(120px, 18vw, 200px)', opacity: 0.12, color: 'var(--wine)', pointerEvents: 'none' }} />
        <Pattern25 style={{ position: 'absolute', bottom: '-15px', right: '-20px', width: 'clamp(120px, 18vw, 200px)', opacity: 0.12, color: 'var(--wine)', pointerEvents: 'none' }} />
